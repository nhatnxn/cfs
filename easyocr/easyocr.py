...
from .utils import group_text_box, get_image_list, calculate_md5, get_paragraph,\
                   download_and_unzip, horizontal_cluster, printProgressBar, diff, reformat_input,\
                   make_rotated_img_list, set_result_with_confidence,\
                   reformat_input_batched, vertical_cluster
from .config import *
...
paddle =  PaddleOCR(det_model_dir='en_ppocr_server_v2.0_det_infer',
                    use_angle_cls=False, 
                    lang='latin', 
                    rec_char_type='en', gpu_mem = 4000, det=False,
                    batch_size=100)
...
class Reader(object):
    ...
    def readtext(self, image, decoder = 'greedy', beamWidth= 5, batch_size = 1,\
                 ...
                 slope_ths = 0.1, ycenter_ths = 0.5, height_ths = 0.5,\
                 width_ths = 0.5, y_ths = 0.5, x_ths = 1.0, add_margin = 0.1, output_format='standard', cluster=False, check_annot=True, page=0):
        '''
        Parameters:
...
#         horizontal_list, free_list = horizontal_list[0], free_list[0]
        ...
        if cluster:
            vertical_blocks = vertical_cluster(free_list=free_list)
            horizontal_blocks = horizontal_cluster(free_list=free_list)
            ...
            # horizontal_result = [result[i][1] for i in horizontal_blocks]
            # horizontal_result=None
            return parh, horizontal_result
