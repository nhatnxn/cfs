...
#         horizontal_list, free_list = horizontal_list[0], free_list[0]
        ...
        ##### for CRAF detection         
        horizontal_list = []
        paddle =  PaddleOCR(det_model_dir='/vinbrain/thoai/DMEC/models/en_ppocr_mobile_v2.0_det_infer', 
                            rec_model_dir='/vinbrain/thoai/DMEC/models/vi_ekyc_ocr',
                            cls_model_dir='/vinbrain/thoai/DMEC/models/ch_ppocr_mobile_v2.0_cls_infer',
                            use_angle_cls=True, 
                            lang='latin', 
                            rec_char_type='en', 
                            rec_char_dict_path='/vinbrain/thoai/DMEC/vi_dict_ekyc.txt')
